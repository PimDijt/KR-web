...
filename = "data/lhbt-hulpverlening.csv"
...
data = 'http://dit.is.de.waarheid.nl/resource'
DATA = Namespace(data)

# A namespace for our vocabulary items (schema information, RDFS, OWL classes and properties etc.)
vocab = 'http://dit.is.de.waarheid.nl/vocab/'
VOCAB = Namespace(vocab)

# The URI for our dataset
graph_uri = URIRef('http://dit.is.de.waarheid.nl/resource/exampledataset')
...
with open('lhbt-rdf.trig','wb') as f:
